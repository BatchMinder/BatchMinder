...
export default function RequestDetail({ request, userRole = 'hod', onClose, onActionSuccess, inline = false }) {
      ...
      {!isPendingHODDecision && onClose && (
        <div
          style={{
            ...
            borderBottomLeftRadius: inline ? '16px' : '24px',
            borderBottomRightRadius: inline ? '16px' : '24px',
          }}
        >
          <button
            onClick={onClose}
